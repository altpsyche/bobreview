"""
MayhemAutomation-specific analysis functions.

These functions were moved from core/analysis.py to keep the core
lean and domain-agnostic. They provide performance-specific analysis.
"""
...
def analyze_performance_data(
    ...
    This is the MayhemAutomation-specific analysis function that calculates
    high_load, low_load, critical hotspots, frame times, and trends.
